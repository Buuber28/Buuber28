...
It can write both summary and detailed validation outputs in `txt` or `html` format.
...
- Both `txt` and `html` output formats are supported.
- This tool validates existing predictions; cross-validation workflow documentation will be added separately.
